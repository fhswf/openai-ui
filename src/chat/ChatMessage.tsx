    ...
    <div className={styles.bar}>
      ...
      <div className={styles.bar_inner}>
        ...
        <div className={styles.bar_icon}>
          ...
          <Icon dataTestId="SendMessageBtn" className={styles.icon} type={t("send")} onClick={sendMessage} />
        </div >
      </div >
    </div >
  )
      ...
      <React.Fragment>
        {
          messages.length ? <div className={styles.container} data-testid="ChatListContainer">
            {messages
              ...
              .map((item, index) => <MessageItem dataTestId="ChatMessage" key={item.id} {...item} />)}
            {message?.error && <Error />}
          </div> : <ChatHelp />
        }
      </React.Fragment>
