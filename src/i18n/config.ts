...
`,
          ...
          mcp_approval_request_description: "An MCP tool requires your approval to execute.",
...
`,
          ...
          mcp_approval_request_description: "Ein MCP-Tool benötigt Ihre Genehmigung zur Ausführung.",
